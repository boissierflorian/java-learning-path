...
def generer_excel_structure(structure, excel_file):
    wb = Workbook()
    ws = wb.active
    ws.title = 'Suivi Spring Framework'
    
    # En-têtes et formats de base
    ws['A1'] = "Suivi de progression - Spring Framework"
...
if __name__ == '__main__':
    ...
    html = fetch_html('https://docs.spring.io/spring-framework/reference/overview.html')
    soup = BeautifulSoup(html, 'html.parser')
    structure = extraire_structure_nav(soup, 'https://docs.spring.io/spring-framework/reference/overview.html')
    generer_excel_structure(structure, 'spring-framework-tracking.xlsx')
